...
(use-package! cider-mode
  ...
  (after! clojure-ts-mode
    (set-repl-handler! '(clojure-ts-mode clojurec-mode) #'+clojure/open-repl :persist t)
    (set-repl-handler! 'clojurescript-mode #'+clojure/open-cljs-repl :persist t)
    (set-eval-handler! '(clojure-ts-mode clojurescript-mode clojurec-mode) #'cider-eval-region))
  ...
  (map! (:localleader
         (:map (clojure-ts-mode-map clojurescript-mode-map clojurec-mode-map)
               "'"  #'cider-jack-in-clj
               "\"" #'cider-jack-in-cljs
               "c"  #'cider-connect-clj
...
(use-package! jet
  :commands (jet)
  :config
  (map! :map (clojure-ts-mode-map clojurescript-mode-map clojurec-mode-map)
        :localleader
        "j" #'jet))
