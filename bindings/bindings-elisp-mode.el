...
(evil-define-key 'normal emacs-lisp-mode-map (kbd "C-<RET>") 'eval-last-sexp)
(evil-define-key 'normal emacs-lisp-mode-map (kbd "M-<RET>") 'eval-sexp-fu-eval-sexp-inner-list)
...
(evil-define-key 'normal emacs-lisp-mode-map (kbd "<localleader><RET>p") 'eval-sexp-fu-eval-sexp-inner-list)
(evil-define-key 'normal emacs-lisp-mode-map (kbd "<localleader><RET>l") 'eval-last-sexp)
