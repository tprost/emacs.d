...
(defun setup-emacs-lisp-mode-bindings ()
	...
	(evil-define-key 'normal emacs-lisp-mode-map (kbd "C-<return>") 'eval-last-sexp)
	(evil-define-key 'normal emacs-lisp-mode-map (kbd "M-<return>") 'eval-sexp-fu-eval-sexp-inner-list)
