...
(defvar flymake-for-csharp-csc-arguments
  (list "/t:module class="string">" "/nologo")
...
and burps if a different /t argument is found."
  ...
  (let ((args flymake-for-csharp-csc-arguments)
    ...
    (while args
      (setq arg (car args))
      (cond
       ((string-equal arg "/t:module class="string">") (setq found t))
       ((string-starts-with arg "/t: class="string">")
        (setq found t)
        (message "flymake-for-csharp: WARNING /t: option present, and not /t:module class="comment">; fix this.")))
    ...
    (if found
      ...
      (flymake-log 1 "flymake-for-csharp-get-csc-arguments: appending /t:module class="string">")
      (setq args
            (append flymake-for-csharp-csc-arguments (list "/t:module class="string">"))))))
          ...
          (progn
            ...
            (cond
             ((or (not (null (string-match "makefile" build-file)))
              ...
              (if (flymake-for-csharp-grep-target-in-build-file "check-syntax: class="string">" build-file)
     ...
     ((string= flavor "msbuild")
      (list (concat  flymake-for-csharp-dotnet-location "\\msbuild.exe")
            (list build-file
                  ...
                  "/nologo"
                  "/t:CheckSyntax class="string">"
                  "/v:quiet class="string">"  ;; normal
                  ;; use file-relative-name to remove the fully-qualified directory name
                  (concat "/property:SourceFileToCheck= class="string">" (file-relative-name source))
                  (concat "/property:OriginalSourceFile= class="string">" (file-relative-name buffer-file-name))
                  )))
     ((string= flavor "nmake")
