...
;; m
(define-key 'my-x-map (kbd "<C-m>") nil)
(define-key 'my-x-map (kbd "<C-m> C-;") 'er/mark-comment)
(define-key 'my-x-map (kbd "C-m C-;") 'er/mark-comment)
(define-key 'my-x-map (kbd "<C-m> C-b") 'mark-whole-buffer)
(define-key 'my-x-map (kbd "C-m C-b") 'mark-whole-buffer)
(define-key 'my-x-map (kbd "<C-m> C-c") 'er/mark-method-call)
(define-key 'my-x-map (kbd "C-m C-c") 'er/mark-method-call)
(define-key 'my-x-map (kbd "<C-m> C-f") 'er/mark-defun)
(define-key 'my-x-map (kbd "C-m C-f") 'er/mark-defun)
(define-key 'my-x-map (kbd "<C-m> C-p") 'er/mark-paragraph)
(define-key 'my-x-map (kbd "C-m C-p") 'er/mark-paragraph)
(define-key 'my-x-map (kbd "<C-m> C-s") 'er/mark-sentence)
(define-key 'my-x-map (kbd "C-m C-s") 'er/mark-sentence)
(define-key 'my-x-map (kbd "<C-m> C-w") 'er/mark-word)
(define-key 'my-x-map (kbd "C-m C-w") 'er/mark-word)
(define-key 'my-x-map (kbd "<C-m> C-'") 'er/mark-inside-quotes)
(define-key 'my-x-map (kbd "C-m C-'") 'er/mark-inside-quotes)
(define-key 'my-x-map (kbd "<C-m> C-\"") 'er/mark-outside-quotes)
(define-key 'my-x-map (kbd "C-m C-\"") 'er/mark-outside-quotes)
(define-key 'my-x-map (kbd "<C-m> C-[") 'er/mark-inside-pairs)
(define-key 'my-x-map (kbd "C-m C-[") 'er/mark-inside-pairs)
(define-key 'my-x-map (kbd "<C-m> C-{") 'er/mark-outside-pairs)
(define-key 'my-x-map (kbd "C-m C-{") 'er/mark-outside-pairs)
(define-key 'my-x-map (kbd "<C-m> C-]") 'er/mark-inside-pairs)
(define-key 'my-x-map (kbd "C-m C-]") 'er/mark-inside-pairs)
(define-key 'my-x-map (kbd "<C-m> C-}") 'er/mark-outside-pairs)
(define-key 'my-x-map (kbd "C-m C-}") 'er/mark-outside-pairs)
(define-key 'my-x-map (kbd "<C-m> C-u") 'er/mark-url)
(define-key 'my-x-map (kbd "C-m C-u") 'er/mark-url)
(define-key 'my-x-map (kbd "<C-m> C-s") 'er/mark-symbol)
(define-key 'my-x-map (kbd "C-m C-s") 'er/mark-symbol)
(define-key 'my-x-map (kbd "<C-m> C-l") 'my-mark-current-line)
(define-key 'my-x-map (kbd "C-m C-l") 'my-mark-current-line)
(define-key 'my-x-map (kbd "<C-m> C-@") 'er/mark-email)
(define-key 'my-x-map (kbd "C-m C-@") 'er/mark-email)
;; (define-key 'my-x-map (kbd "C-H-m")'er/expand-region)
;; (define-key 'my-x-map (kbd "C-H-S-") 'er/contract-region)
;; (define-key 'my-x-map (kbd "C-H-x C") 'l-extended-selection)
...
(define-key 'my-x-map (kbd "C-. C-;") 'er/mark-comment)
(define-key 'my-x-map (kbd "C-. C-b") 'mark-whole-buffer)
(define-key 'my-x-map (kbd "C-. C-c") 'er/mark-method-call)
(define-key 'my-x-map (kbd "C-. C-f") 'er/mark-defun)
(define-key 'my-x-map (kbd "C-. C-p") 'er/mark-paragraph)
(define-key 'my-x-map (kbd "C-. C-s") 'er/mark-sentence)
(define-key 'my-x-map (kbd "C-. C-w") 'er/mark-word)
(define-key 'my-x-map (kbd "C-. C-'") 'er/mark-inside-quotes)
(define-key 'my-x-map (kbd "C-. C-\"") 'er/mark-outside-quotes)
(define-key 'my-x-map (kbd "C-. C-[") 'er/mark-inside-pairs)
(define-key 'my-x-map (kbd "C-. C-{") 'er/mark-outside-pairs)
(define-key 'my-x-map (kbd "C-. C-]") 'er/mark-inside-pairs)
(define-key 'my-x-map (kbd "C-. C-}") 'er/mark-outside-pairs)
(define-key 'my-x-map (kbd "C-. C-u") 'er/mark-url)
(define-key 'my-x-map (kbd "C-. C-s") 'er/mark-symbol)
(define-key 'my-x-map (kbd "C-. C-l") 'my-mark-current-line)
(define-key 'my-x-map (kbd "C-. C-@") 'er/mark-email)
