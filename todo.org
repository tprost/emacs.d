...
* TODO [#A] bindings for opening .emacs.d and related files?
* TODO [#A] quick jump to emacs bindings.el, settings.el, emacs find file
...
* TODO [#A] fix evil mode for dired mode
...
* TODO [#A] fix region highlight and cursor for evil normal mode
* Haskell Mode
